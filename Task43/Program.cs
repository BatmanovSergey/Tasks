...
// Ещё варинат условия, более изящный
...
// else
// {
//     if (b1 == b2) Console.WriteLine("Заданные прямые коллинеарны");
//     else Console.WriteLine("Заданные прямые не имеют общих точек. Они параллельны друг другу");
// }